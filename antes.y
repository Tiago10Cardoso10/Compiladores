...
%type <no> FunctionsAndDeclarations FunctionAndDeclarations2 FunctionDefinition FunctionBody DeclarationAndStatement2 DeclarationsAndStatement FunctionDeclaration FunctionDeclarator ParameterList ParameterDeclaration Declaration Declaration2 TypeSpec Declarator Statement Expr Expr2
...
Statement:
    ...
    | IF LPAR Expr2 RPAR Statement                           {}
    | IF LPAR Expr2 RPAR Statement ELSE Statement            {}
    | WHILE LPAR Expr2 RPAR Statement                        {}
    | RETURN SEMI                                           {}
    | RETURN Expr2 SEMI                                      {}
